...
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=HZciELCD#xQ7caI5ZFVgNbkWw7vg1XLX87ExuMP-0cb5PRKCju4M' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94704147964' : process.env.OWNER_NUMBER,   
